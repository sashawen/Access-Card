...
//		menuBar.setForeground(Color.BLACK);
		...
		tabbedPane.addTab("Cafe Map", null, panel_cafe, null);
		...
		list_cafe.setModel(new AbstractListModel() {
			String[] values = new String[] {"1. Cellar Market", "2. Mission Bakery and Café", "3. The Bronco", "4. Market Place"};
			public int getSize() {
		...
		//JScrollPane panel_vending = new JScrollPane();
